...
class Model3D_Monocular(Model3D):
    ...
    binocular_model: "Model3D_Binocular_PerForM" = None
...
class GazerHMD3D(GazerBase):
    label = "3D_Binocular_PerForM"
...
class PosthocGazerHMD3D(GazerBase):
    label = "PostHoc3D_Binocular_PerForM"
